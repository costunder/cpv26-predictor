...
"${cpv26_python}" -m compileall -q src tests scripts/build_code_summary.py scripts/conda_guard.py scripts/audit_cross_era_graph.py
"${cpv26_python}" -m ruff check src tests scripts/build_code_summary.py scripts/conda_guard.py scripts/audit_cross_era_graph.py
